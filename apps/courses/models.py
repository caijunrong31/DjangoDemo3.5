...
class Course(models.Model):
    ...
    learn_times = models.IntegerField(default=0, verbose_name=u"学习时长(已分钟为单位)")
    ...
    yuneed_know = models.CharField(default="", max_length=300, verbose_name=u"课程须知")
...
class BannerCourse(Course):
    class Meta:
        verbose_name = u"轮播课程"
        verbose_name_plural = verbose_name
        proxy = True # 设置成True,能实现一张表两个管理器
